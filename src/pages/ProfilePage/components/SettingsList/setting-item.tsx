...
const SettingItem: React.FC<TSettingItemProps> = ({ icon: Icon, link, text }) => {
    return (
        <div className="flex justify-between items-center border-b-[1px] border-mono-sky-lighter pb-4 w-full">

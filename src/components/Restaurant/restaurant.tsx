...
const Restaurant: React.FC<TRestaurantProps> =
    ({
         id,
         categories,
         closed,
        ...
        const containerClasses = classNames("h-[170px] shadow-main rounded-lg bg-white", {
        ...
        return (
            <div className={containerClasses}>
                <div className="w-full h-[100px] relative rounded-t-lg cursor-pointer" onClick={onContainerClicked}>
                    ...
                    <div
                        className="bg-mono-sky-lightest w-[50px] h-[20px] rounded-[4px] absolute bottom-[9px] left-[9px] flex justify-center items-center">
